...
export const translations: Partial<TranslationsDictionary> = {
  ...
  'site.description':
    "Papra est une plateforme open-source pour organiser, sécuriser et archiver tous vos documents, sans effort. Commencez à digitaliser votre vie dès aujourd'hui !",
  ...
  'values.subtitle':
    'On développe des logiciels comme il faut. <br /> Sans compromis, sans raccourcis.',

  'values.ethical-by-design.title': 'Éthique dès la conception',
  'values.ethical-by-design.description':
    'Aucune manipulation, aucune astuce douteuse. Un logiciel qui vous respecte vraiment.',

  'values.bootstrapped-and-independent.title': 'Autofinancé & Indépendant',
  'values.bootstrapped-and-independent.description':
    'Pas de levée de fonds, pas de dilution, zéro dette. On répond à nos utilisateurs, pas à des investisseurs.',

  'values.your-data-is-yours.title': 'Vos données restent vôtres',
  'values.your-data-is-yours.description':
    'On ne vend jamais vos données. Point. La vie privée est un droit fondamental, pas une option.',

  'values.fully-open-source.title': '100% Open Source',
  'values.fully-open-source.description':
    'Transparence totale. Auditez le code, contribuez ou auto-hébergez quand vous voulez.',

  'values.environmentally-conscious.title': "Respectueux de l'environnement",
  'values.environmentally-conscious.description':
    "La durabilité et l'éco-responsabilité guident nos choix techniques et notre conception.",

  'values.community-driven.title': 'Fait par et pour la communauté',
  'values.community-driven.description':
    "Vos retours façonnent notre feuille de route. C'est vous qui décidez.",

  // Features Section
  'features.title': 'Fonctionnalités',
  'features.subtitle':
    "Gérez vos documents simplement. Papra vous aide à organiser, rechercher et accéder à vos fichiers en un clin d'œil.",

  'features.all-in-one.title': 'Tous vos documents réunis',
  'features.all-in-one.description':
    'Fini les fichiers éparpillés partout. Avec Papra, archivez et organisez tout au même endroit.',

  'features.organizations.title': 'Organisations',
  'features.organizations.description':
    "Structurez vos documents par organisation. Idéal pour gérer les fichiers d'une équipe ou d'une entreprise.",

  'features.tagging.title': 'Étiquettes intelligentes',
  'features.tagging.description':
    'Catégorisez et filtrez vos documents avec des étiquettes. Créez même des règles pour les assigner automatiquement.',

  'features.search.title': 'Recherche ultra-rapide',
  'features.search.description':
    "Trouvez n'importe quel document en quelques secondes. Fini le scroll interminable.",
  ...
  'features.developer-friendly.description':
    'API complète, webhooks, CLI et SDK. Intégrez Papra dans votre workflow existant comme vous le voulez.',

  'features.email-ingestion.title': 'Import par email',
  'features.email-ingestion.description':
    'Créez une adresse email dédiée et transférez-y vos messages. Les pièces jointes deviennent automatiquement des documents.',

  // Footer Section
  'footer.made-in-europe':
    'Papra est créé et hébergé en Europe avec <span class="i-tabler-heart-filled size-3.5 mb--0.3 text-primary inline-block"></span> par <a href="https://corentin.tech" class="text-primary border-b hover:border-b-primary transition">Corentin Thomasset</a>.',
  ...
  'home.open-source.description':
    'Tout l\'écosystème Papra est open-source et auto-hébergeable. Disponible sur <a href="https://github.com/papra-hq/papra" class="text-primary hover:underline">GitHub</a> sous licence <a href="https://github.com/papra-hq/papra/blob/main/LICENSE" class="text-primary hover:underline">AGPL-3.0</a>.',
  ...
  'home.faq.questions': [
    {
      ...
      answer:
        'Papra est une plateforme open-source de gestion documentaire. Elle centralise tous vos fichiers au même endroit pour les organiser, les sécuriser et les archiver facilement.',
    },
    {
      question: "C'est vraiment open-source ?",
      answer:
        "Oui ! Le code est sous licence AGPL-3.0 et disponible sur GitHub. Vous pouvez l'auto-héberger si vous le souhaitez.",
    },
    {
      question: 'Comment on organise les documents ?',
      answer:
        'Papra combine organisations, étiquettes et recherche puissante. Créez des espaces pour vos équipes, ajoutez des tags pour catégoriser, et retrouvez tout en un instant.',
    },
    {
      question: "Je peux l'auto-héberger ?",
      answer:
        "Absolument ! C'est même l'un des gros avantages de l'open-source. Vos données restent chez vous, et vous personnalisez tout comme bon vous semble.",
    },
    {
      question: 'Quels fichiers sont supportés ?',
      answer:
        'PDF, texte, code, factures, tableurs... Tous les formats courants de la gestion documentaire pro et perso.',
    },
    {
    ...
    },
    {
      ...
      answer:
        "Super simple : créez un compte gratuit, uploadez vos docs et c'est parti. Consultez la doc pour aller plus loin.",
    },
  ],
  ...
  'pricing.subtitle':
    'Choisissez le plan qui vous correspond. Toutes les fonctionnalités essentielles incluses.',
  'pricing.toggle.monthly': 'Mensuel',
  'pricing.toggle.annual': 'Annuel',
  'pricing.currency-note':
    'Prix affichés en USD. Votre banque fera la conversion en euros au moment du paiement.',
  ...
  'pricing.enterprise.description':
    "Besoin d'un plan sur mesure pour votre organisation ? <br /> On propose des solutions entreprise avec fonctionnalités avancées, support dédié et tarifs flexibles. Contactez-nous pour en discuter.",
  'pricing.self-hosting.title': 'Auto-hébergement',
  'pricing.self-hosting.description':
    'Papra est open-source, sous licence <a href="https://github.com/papra-hq/papra/blob/main/LICENSE" class="underline hover:text-primary transition">AGPLv3</a>, et s\'auto-héberge gratuitement sur votre propre infrastructure. <br />Démarrez avec notre doc.',
  ...
  'pricing.faq.questions': [
    {
      ...
      answer:
        "Oui, upgrade ou downgrade quand vous voulez. Si vous passez à un plan supérieur, on facture au prorata pour le temps restant. Si vous descendez, le changement s'applique à la fin de votre période actuelle.",
    },
    {
      question: 'Que se passe-t-il si je dépasse mon stockage ?',
      answer:
        "Si vous atteignez la limite, vous ne pourrez plus uploader tant que vous n'aurez pas upgradé votre plan ou supprimé des docs. On vous prévient avant d'arriver à la limite.",
    },
    {
      question: 'Y a un essai gratuit pour les plans payants ?',
      answer:
        'Commencez avec le plan Gratuit pour tester Papra. Quand vous êtes prêt, passez à un plan payant quand vous voulez.',
    },
    {
      question: 'Quels moyens de paiement vous acceptez ?',
      answer:
        'On accepte toutes les cartes bancaires (Visa, MasterCard, American Express). Tous les paiements sont sécurisés via notre prestataire.',
    },
    {
      question: 'Je peux annuler quand je veux ?',
      answer:
        "Oui, annulez quand vous voulez. Votre compte reste actif jusqu'à la fin de votre période en cours, puis vous passez au plan Gratuit.",
    },
    {
    ...
    },
    {
      ...
      answer:
        'Au paiement, cliquez sur "Ajouter un code promotionnel" dans les détails. Entrez votre code et la réduction s\'applique automatiquement.',
    },
    {
      question: 'Je peux ajouter des membres plus tard ?',
      answer:
        'Oui, chaque plan a une limite de membres. Si vous en avez besoin de plus, passez à un plan supérieur ou contactez-nous pour une solution entreprise sur mesure.',
    },
  ],
  ...
  'pricing.discount-banner.description':
    "Bénéficiez de 50% de réduction à vie en passant vos organisations à n'importe quel plan payant pendant notre période de lancement. Cette offre expire le 31 décembre 2025 !",

  // Contact Page
  'contact.title': 'Nous contacter',
  'contact.subtitle':
    "Une question ou un retour à faire ? On serait ravis de vous lire. Contactez-nous via n'importe lequel de ces canaux.",
  'contact.general-inquiries.title': 'Questions générales',
  'contact.general-inquiries.description':
    "Pour toute question, retour ou demande d'assistance, écrivez-nous par email.",
  ...
  'contact.bug.description':
    'Signalez les bugs ou problèmes que vous rencontrez en utilisant Papra.',
  'contact.bug.button-label': 'Signaler sur GitHub',
  'contact.community.title': 'Rejoignez la communauté',
  'contact.community.description':
    "Échangez avec nous et d'autres utilisateurs sur Discord, partagez vos idées et obtenez de l'aide.",
  'contact.community.button-label': 'Rejoindre Discord',
  'contact.connect.title': 'Suivez-nous',
  'contact.connect.description':
    'Restez au courant des dernières actus et mises à jour en nous suivant sur les réseaux sociaux.',
