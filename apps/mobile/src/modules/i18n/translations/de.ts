...
export const de = {
  ...
  documents: {
    ...
    tagPicker: {
      ...
      updating: 'Tags werden aktualisiert…',
      loadFailed: 'Tags konnten nicht geladen werden. Bitte versuchen Sie es erneut.',
      updateFailed: 'Tags konnten nicht aktualisiert werden. Bitte versuchen Sie es erneut.',
      empty: 'In dieser Organisation gibt es noch keine Tags.',
