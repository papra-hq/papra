...
const yearOptions = (() => {
  ...
  return Array.from({ length: YEAR_RANGE_OFFSET * 2 + 1 }, (_, i) =>
    String(currentYear - YEAR_RANGE_OFFSET + i),
  );
})();
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center">
        <Select
          ...
          onChange={(value) =>
            value != null &&
            context.setMonth(new Date(context.month().getFullYear(), Number(value), 1))
          }
        ...
        >
          <SelectTrigger
            class="border-none hover:bg-accent shadow-none text-sm font-medium gap-0"
            caretIcon={null}
          >
        ...
        <Select
          ...
          onChange={(value) =>
            value != null &&
            context.setMonth(new Date(Number(value), context.month().getMonth(), 1))
          }
          options={yearOptions}
          itemComponent={(itemProps) => (
