export function rawPropertyValueAsOption(
  value: unknown,
): { optionId: string; name: string } | null {
  if (
    typeof value === 'object' &&
    value !== null &&
    'optionId' in value &&
...
export function rawPropertyValueAsOptionArray(
  value: unknown,
...
export function rawPropertyValueAsUserArray(
  value: unknown,
...
export function rawPropertyValueAsRelatedDocumentArray(
  value: unknown,
