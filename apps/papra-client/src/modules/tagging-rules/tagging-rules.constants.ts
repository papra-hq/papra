...
export const TAGGING_RULE_OPERATORS_LOCALIZATION_KEYS: Record<
  (typeof TAGGING_RULE_OPERATORS)[keyof typeof TAGGING_RULE_OPERATORS],
  TranslationKeys
> = {
...
export const TAGGING_RULE_FIELDS_LOCALIZATION_KEYS: Record<
  (typeof TAGGING_RULE_FIELDS)[keyof typeof TAGGING_RULE_FIELDS],
  TranslationKeys
> = {
...
export const CONDITION_MATCH_MODES_LOCALIZATION_KEYS: Record<
  (typeof CONDITION_MATCH_MODES)[keyof typeof CONDITION_MATCH_MODES],
  TranslationKeys
> = {
