export const translations = {
  ...
  'views.no-views.title': 'No views yet',
  'views.no-views.description': 'Views are saved searches that let you quickly access filtered sets of documents. Create a view with a query to get started.',
  'views.no-views.create-view': 'Create view',
  'views.title': 'Views',
  ...
  'views.delete.confirm.message': 'Are you sure you want to delete this view?',
  'views.delete.confirm.confirm-button': 'Delete',
  'views.delete.confirm.cancel-button': 'Cancel',
  'views.delete.success': 'View deleted successfully',
  'views.create.success': 'View "{{ name }}" created successfully.',
  'views.update.success': 'View "{{ name }}" updated successfully.',
  'views.form.name.label': 'Name',
  'views.form.name.placeholder': 'Eg. Inbox',
  'views.form.name.required': 'Please enter a view name',
  'views.form.name.max-length': 'View name must be less than 100 characters',
  'views.form.query.label': 'Query',
  'views.form.query.placeholder': 'Eg. tag:inbox AND -tag:archived',
  'views.form.query.required': 'Please enter a query',
  'views.form.query.max-length': 'Query must be less than 500 characters',
  'views.form.query.hint': 'Use the same syntax as the document search bar. Eg. tag:inbox, has:tags, before:2024-01-01',
  'views.table.headers.name': 'Name',
  'views.table.headers.query': 'Query',
  'views.table.headers.actions': 'Actions',
  'views.view.no-documents': 'No documents match this view\'s query.',
  'views.view.not-found': 'View not found.',
  'api-errors.views.already_exists': 'A view with this name already exists for this organization',
  'api-errors.views.not_found': 'View not found',
