export const translations = {
  ...
  "user.settings.name.description":
    "Your full name is displayed to other organization members.",
  ...
  "organization.settings.delete.confirm.message":
    "Are you sure you want to delete this organization? This action cannot be undone, and all data associated with this organization will be permanently removed.",
  ...
  "import-documents.title.pending":
    "{{ count }} / {{ total }} documents imported",
  ...
  "tags.form.description.placeholder":
    "Eg. All the contracts signed by the company",
  ...
  "tagging-rules.form.description.placeholder":
    "Example: Tag documents with 'invoice' in the name",
  "tagging-rules.form.description.max-length":
    "The description must be less than 256 characters",
  "tagging-rules.form.conditions.label": "Conditions",
  "tagging-rules.form.conditions.description":
    "Define the conditions that must be met for the rule to apply. All conditions must be met for the rule to apply.",
  ...
  "intake-emails.allowed-origins":
    "Allowed from {{ count }} address{{ plural }}",
  ...
  "api-keys.create.description":
    "Create a new API key to access the Papra API.",
  ...
  "api-keys.list.empty.description":
    "Create an API key to access the Papra API.",
  ...
  "webhooks.events.documents.document:tag:added.description":
    "A tag is added to a document",
  "webhooks.events.documents.document:tag:removed.description":
    "A tag is removed from a document",
  ...
  "api-errors.intake-emails.already_exists":
    "This intake email address already exists. Please try again.",
  ...
  "api-errors.user.already_in_organization":
    "This user is already in this organization.",
  ...
  "api-errors.tags.already_exists":
    "A tag with this name already exists for this organization",
  ...
  "demo.popup.discord":
    "Join the {{ discordLink }} to get support, propose features or just chat.",
