export const translations = {
  ...
  'custom-properties.no-properties.title': 'No custom properties yet',
  'custom-properties.no-properties.description': 'Custom properties let you add structured metadata to your documents, such as expiration dates, company names, or amounts.',
  'custom-properties.no-properties.create': 'Create property',

  'custom-properties.title': 'Custom Properties',
  'custom-properties.description': 'Define custom metadata fields for your documents. Properties can be text, numbers, dates, booleans, or selection lists.',
  'custom-properties.create': 'Create property',
  'custom-properties.update': 'Update property',
  'custom-properties.delete': 'Delete property',

  'custom-properties.delete.confirm.title': 'Delete custom property',
  'custom-properties.delete.confirm.message': 'Are you sure you want to delete this property? All values set on documents for this property will be permanently removed.',
  'custom-properties.delete.confirm.confirm-button': 'Delete',
  'custom-properties.delete.confirm.cancel-button': 'Cancel',
  'custom-properties.delete.success': 'Custom property deleted successfully',
  'custom-properties.create.success': 'Property "{{ name }}" created successfully.',
  'custom-properties.update.success': 'Property "{{ name }}" updated successfully.',

  'custom-properties.form.name.label': 'Name',
  'custom-properties.form.name.placeholder': 'Eg. Expiration date',
  'custom-properties.form.name.required': 'Please enter a property name',
  'custom-properties.form.name.max-length': 'Property name must be less than 128 characters',
  'custom-properties.form.description.label': 'Description',
  'custom-properties.form.description.optional': '(optional)',
  'custom-properties.form.description.placeholder': 'Eg. The date this document expires',
  'custom-properties.form.description.max-length': 'Description must be less than 512 characters',
  'custom-properties.form.type.label': 'Type',
  'custom-properties.form.type.placeholder': 'Select a type',
  'custom-properties.form.color.label': 'Color',
  'custom-properties.form.required.label': 'Required',
  'custom-properties.form.no-description': 'No description',

  'custom-properties.form.options.label': 'Options',
  'custom-properties.form.options.add': 'Add option',
  'custom-properties.form.options.value.placeholder': 'Option value',
  'custom-properties.form.options.empty': 'No options defined. Add at least one option for select properties.',
  ...
  'custom-properties.table.headers.name': 'Name',
  'custom-properties.table.headers.type': 'Type',
  'custom-properties.table.headers.description': 'Description',
  'custom-properties.table.headers.required': 'Required',
  'custom-properties.table.headers.created': 'Created',
  'custom-properties.table.headers.actions': 'Actions',

  'custom-properties.document.title': 'Properties',
  'custom-properties.document.no-properties': 'No custom properties defined for this organization.',
  'custom-properties.document.no-value': 'Not set',
  'custom-properties.document.save.success': 'Property value saved',
  'custom-properties.document.remove.success': 'Property value removed',
  'custom-properties.document.true': 'Yes',
  'custom-properties.document.false': 'No',
  ...
  'api-errors.custom_property_definition.already_exists': 'A custom property with this name already exists for this organization.',
  'api-errors.custom_property_definition.organization_limit_reached': 'The maximum number of custom properties for this organization has been reached.',
  'api-errors.custom_property_definition.not_found': 'Custom property definition not found.',
  'api-errors.custom_property_definition.type_change_not_allowed': 'Changing the type of a custom property is not allowed.',
  'api-errors.custom_property_value.invalid': 'The provided value is invalid for this property type.',
  'api-errors.custom_property_select_option.not_found': 'The provided value is not a valid option for this select property.',
