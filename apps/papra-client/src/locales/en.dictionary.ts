export const translations = {
  ...
  'documents.list.selection.count': '{{ count }} {{ count, =1:document, documents }} selected',
  'documents.list.bulk-actions.add-tags': 'Add tags',
  'documents.list.bulk-actions.delete': 'Delete',
  'documents.list.bulk-actions.clear': 'Clear selection',
  'documents.list.bulk-actions.delete-confirm.title': 'Delete {{ count }} {{ count, =1:document, documents }}',
  'documents.list.bulk-actions.delete-confirm.message': '{{ count, =1:This document, These documents }} will be moved to the trash.',
  'documents.list.bulk-actions.delete-success': '{{ count }} {{ count, =1:document, documents }} moved to trash',
  'documents.list.bulk-actions.add-tags-success': 'Tag added to {{ count }} {{ count, =1:document, documents }}',
  'documents.list.bulk-actions.partial-error': '{{ errorCount }} {{ errorCount, =1:operation, operations }} failed',
