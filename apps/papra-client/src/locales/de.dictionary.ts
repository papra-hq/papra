...
export const translations: Partial<TranslationsDictionary> = {
  ...
  'tagging-rules.apply.confirm.description': 'Dies überprüft alle vorhandenen Dokumente in Ihrer Organisation und wendet Tags an, wo Bedingungen übereinstimmen. Dies kann einen Moment dauern.',
  'tagging-rules.apply.confirm.button': 'Regel anwenden',
  'tagging-rules.apply.success': 'Regel auf {{ count }} Dokument(e) angewendet',
  'tagging-rules.apply.error': 'Fehler beim Anwenden der Regel',
  'tagging-rules.apply.processing': 'Regel wird angewendet...',
