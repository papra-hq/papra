...
export const translations: Partial<TranslationsDictionary> = {
  ...
  "organization.settings.page.description":
    "Verwalten Sie hier Ihre Organisationseinstellungen.",
  ...
  "organization.settings.subscription.error":
    "Kundenportal-URL konnte nicht abgerufen werden",
  ...
  "organization.settings.delete.confirm.message":
    "Sind Sie sicher, dass Sie diese Organisation löschen möchten? Diese Aktion kann nicht rückgängig gemacht werden und alle mit dieser Organisation verbundenen Daten werden dauerhaft entfernt.",
  ...
  "organizations.members.description":
    "Verwalten Sie Ihre Organisationsmitglieder",
  ...
  "organizations.invite-member.description":
    "Laden Sie ein Mitglied in Ihre Organisation ein",
  ...
  "organizations.invitations.description":
    "Verwalten Sie Ihre Organisationseinladungen",
  ...
  "documents.rename.form.name.required":
    "Bitte geben Sie einen Namen für das Dokument ein",
  "documents.rename.form.name.max-length":
    "Der Name muss weniger als 255 Zeichen lang sein",
  ...
  "import-documents.title.pending":
    "{{ count }} / {{ total }} Dokumente importiert",
  ...
  "activity.document.updated.multiple":
    "Die Felder {{ fields }} wurden aktualisiert",
  ...
  "activity.no-more-activities":
    "Keine weiteren Aktivitäten für dieses Dokument",
  ...
  "tags.form.description.placeholder":
    "Z.B. Alle von der Firma unterzeichneten Verträge",
  "tags.form.description.max-length":
    "Beschreibung muss weniger als 256 Zeichen lang sein",
  ...
  "tagging-rules.form.name.min-length":
    "Bitte geben Sie einen Namen für die Regel ein",
  "tagging-rules.form.name.max-length":
    "Der Name muss weniger als 64 Zeichen lang sein",
  ...
  "tagging-rules.form.conditions.description":
    "Definieren Sie die Bedingungen, die erfüllt sein müssen, damit die Regel angewendet wird. Alle Bedingungen müssen erfüllt sein, damit die Regel angewendet wird.",
  ...
  "tagging-rules.form.conditions.no-conditions.confirm":
    "Regel ohne Bedingungen anwenden",
  ...
  "tagging-rules.form.tags.min-length":
    "Es ist mindestens ein anzuwendender Tag erforderlich",
  ...
  "tagging-rules.update.error":
    "Tagging-Regel konnte nicht aktualisiert werden",
  ...
  "intake-emails.count":
    "{{ count }} Eingangse-Mail{{ plural }} für diese Organisation",
  ...
  "intake-emails.allowed-origins":
    "Zulässig von {{ count }} Adresse{{ plural }}",
  ...
  "intake-emails.allowed-origins.add.label":
    "Zulässige Ursprungs-E-Mail hinzufügen",
  ...
  "webhooks.create.description":
    "Erstellen Sie einen neuen Webhook, um Ereignisse zu empfangen",
  ...
  "webhooks.create.form.events.required":
    "Mindestens ein Ereignis ist erforderlich",
  ...
  "api-errors.intake_email.limit_reached":
    "Die maximale Anzahl an Eingangs-EMails für diese Organisation wurde erreicht. Bitte aktualisieren Sie Ihren Plan, um weitere Eingangse-Mails zu erstellen.",
  "api-errors.intake-emails.already_exists":
    "Diese Eingangs-EMail-Adresse existiert bereits. Bitte versuchen Sie es erneut.",
  ...
  "api-errors.user.already_in_organization":
    "Dieser Benutzer ist bereits in dieser Organisation.",
  ...
  "api-errors.demo.not_available":
    "Diese Funktion ist in der Demo nicht verfügbar",
