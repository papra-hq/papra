...
export const translations: Partial<TranslationsDictionary> = {
  ...
  "organizations.create.form.name.required":
    "Por favor, insira um nome para a organização",
  ...
  "organization.settings.page.description":
    "Gerencie aqui as configurações da sua organização.",
  ...
  "organization.settings.subscription.error":
    "Falha ao obter o link do portal do cliente",
  ...
  "organization.settings.delete.confirm.message":
    "Tem certeza de que deseja excluir esta organização? Esta ação não pode ser desfeita e todos os dados associados serão permanentemente removidos.",
  ...
  "import-documents.no-import-in-progress":
    "Nenhuma importação de documentos em andamento",
  ...
  "documents.preview.binary-file":
    "Arquivos binários não podem ser exibidos como texto",

  "trash.delete-all.button": "Excluir tudo",
  "trash.delete-all.confirm.title":
    "Excluir todos os documentos permanentemente?",
  ...
  "trash.deleted.success.description":
    "O documento foi excluído permanentemente.",
  ...
  "tagging-rules.form.description.placeholder":
    "Exemplo: Marcar documentos com 'fatura' no nome",
  ...
  "tagging-rules.form.conditions.description":
    "Defina as condições que devem ser atendidas para que a regra seja aplicada. Todas as condições devem ser atendidas.",
  ...
  "tagging-rules.form.conditions.value.min-length":
    "Por favor, insira um valor para a condição",
  ...
  "tagging-rules.form.tags.min-length":
    "Ao menos uma tag para aplicar é necessária",
  ...
  "intake-emails.count":
    "{{ count }} e-mail{{ plural }} de entrada para esta organização",
  ...
  "api-keys.create.description":
    "Crie uma nova chave de API para acessar a API do Papra.",
  ...
  "api-keys.list.empty.description":
    "Crie uma chave de API para acessar a API do Papra.",
  ...
  "api-errors.user.already_in_organization":
    "Este usuário já faz parte desta organização.",
  ...
  "api-errors.tags.already_exists":
    "Já existe uma tag com este nome nesta organização",
