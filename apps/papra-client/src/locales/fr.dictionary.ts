...
export const translations: Partial<TranslationsDictionary> = {
  ...
  "auth.register.description":
    "Créez un compte pour commencer à utiliser Papra.",
  ...
  "auth.register.form.name.max-length":
    "Le nom doit contenir moins de {{ maxLength }} caractères",
  ...
  "organizations.create.form.name.required":
    "Veuillez entrer un nom pour l'organisation",
  ...
  "organization.settings.page.description":
    "Gérez les paramètres de votre organisation ici.",
  ...
  "organization.settings.subscription.error":
    "Échec de la récupération de l'URL du portail client",
  ...
  "organization.settings.delete.confirm.message":
    "Êtes-vous sûr de vouloir supprimer cette organisation ? Cette action est irréversible, et toutes les données associées à cette organisation seront supprimées définitivement.",
  ...
  "organizations.invite-member.description":
    "Invite un membre à votre organisation",
  ...
  "organizations.invite-member.success.description":
    "L'email a été invité à l'organisation.",
  "organizations.invite-member.error.message":
    "Échec de l'invitation du membre",
  ...
  "documents.rename.form.name.max-length":
    "Le nom doit contenir moins de 255 caractères",
  ...
  "tags.form.name.max-length":
    "Le nom du tag doit contenir moins de 64 caractères",
  ...
  "tags.form.description.placeholder":
    "Exemple: Tous les contrats signés par l'entreprise",
  ...
  "tagging-rules.create.error":
    "Échec de la création de la règle de catégorisation",
  ...
  "tagging-rules.form.name.max-length":
    "Le nom doit contenir moins de 64 caractères",
  ...
  "tagging-rules.form.conditions.description":
    "Définissez les conditions que doivent remplir la règle pour qu'elle s'applique. Toutes les conditions doivent être remplies pour que la règle s'applique.",
  ...
  "tagging-rules.form.conditions.no-conditions.confirm":
    "Appliquer la règle sans conditions",
  ...
  "tagging-rules.form.conditions.value.min-length":
    "Veuillez entrer une valeur pour la condition",
  ...
  "tagging-rules.form.tags.min-length":
    "Au moins un tag à appliquer est requis",
  ...
  "tagging-rules.update.error":
    "Échec de la mise à jour de la règle de catégorisation",
  ...
  "intake-emails.count":
    "{{ count }} intake email{{ plural }} for this organization",
  ...
  "intake-emails.allowed-origins":
    "Autorisées depuis {{ count }} adresse{{ plural }}",
  ...
  "intake-emails.allowed-origins.add.label":
    "Ajouter une adresse d'origine autorisée",
  ...
  "api-keys.create.description":
    "Créer une nouvelle clé API pour accéder à l'API de Papra.",
  ...
  "api-keys.list.empty.description":
    "Créez une clé API pour accéder à l'API de Papra.",
  ...
  "webhooks.events.documents.document:tag:added.description":
    "Un tag est ajouté à un document",
  "webhooks.events.documents.document:tag:removed.description":
    "Un tag est retiré d'un document",
  ...
  "command-palette.search.placeholder":
    "Rechercher des commandes ou des documents",
  ...
  "api-errors.user.already_in_organization":
    "Cet utilisateur est déjà dans cette organisation.",
  ...
  "api-errors.tags.already_exists":
    "Un tag avec ce nom existe déjà pour cette organisation",
