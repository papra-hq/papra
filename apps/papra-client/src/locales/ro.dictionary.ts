...
export const translations: Partial<TranslationsDictionary> = {
  ...
  "auth.request-password-reset.form.submit":
    "Trimite cererea de resetare a parolei",

  "auth.reset-password.title": "Resetează parola",
  "auth.reset-password.description":
    "Introdu o parolă noua pentră a o reseta pe cea veche.",
  ...
  "auth.register.form.name.max-length":
    "Numele trebuie să fie de minim {{ maxLength }} caractere",
  ...
  "user.settings.name.description":
    "Numele complet este afișat altor membri din organizație.",
  ...
  "organization.settings.page.description":
    "Gestionează setarile organizației aici.",
  ...
  "organization.settings.delete.confirm.message":
    "Ești sigur că vrei să ștergi această organizație? Aceasta operatie nu poate fi anulată si toate datele asociate cu aceasta vor fi eliminate definitiv.",
  ...
  "organizations.members.update-role.success":
    "Rolul membrului a fost actualizat",
  ...
  "organizations.invitations.description":
    "Gestionează invitațiile la organizație",
  ...
  "documents.rename.form.name.required":
    "Te rugăm să introduci un nume pentru document",
  "documents.rename.form.name.max-length":
    "Numele trebuie să aibă mai puțin de 255 de caractere",
  ...
  "documents.preview.binary-file":
    "Acesta pare a fi un fișier binar și nu poate fi afișat ca text",
  ...
  "activity.document.updated.multiple":
    "Câmpurile {{ fields }} au fost actualizate",
  ...
  "tags.form.name.max-length":
    "Numele etichetei trebuie să aibă mai puțin de 64 de caractere",
  ...
  "tags.form.description.placeholder":
    "Ex. Toate contractele semnate de companie",
  ...
  "tagging-rules.create.success":
    "Regula de etichetare a fost creată cu succes",
  ...
  "tagging-rules.form.name.max-length":
    "Numele trebuie să aibă mai puțin de 64 de caractere",
  ...
  "tagging-rules.form.conditions.description":
    "Definește condițiile care trebuie îndeplinite pentru ca regula să se aplice. Toate condițiile trebuie îndeplinite pentru ca regula să se aplice.",
  ...
  "tagging-rules.form.tags.min-length":
    "Este necesară cel puțin o etichetă de aplicat",
  ...
  "intake-emails.count":
    "{{ count }} email{{ plural }} de primire pentru această organizație",
  ...
  "intake-emails.allowed-origins":
    "Permis de la {{ count }} adrese{{ plural }}",
  ...
  "intake-emails.allowed-origins.add.label":
    "Adaugă adresa de e-mail de origine permisă",
  ...
  "api-keys.create.description":
    "Creează o nouă cheie API pentru a accesa API-ul Papra.",
  ...
  "api-keys.create.form.name.required":
    "Te rugăm să introduci un nume pentru cheia API",
  "api-keys.create.form.permissions.label": "Permisiuni",
  "api-keys.create.form.permissions.required":
    "Te rugăm să selectezi cel puțin o permisiune",
  ...
  "api-keys.list.empty.description":
    "Creează o cheie API pentru a accesa API-ul Papra.",
  ...
  "webhooks.create.description":
    "Creează un nou webhook pentru a primi evenimente",
  ...
  "webhooks.delete.confirm.message":
    "Ești sigur ca vrei să ștergi acest webhook?",
  ...
  "api-errors.intake-emails.already_exists":
    "Această adresă de email de primire există deja. Te rugăm să încerci din nou.",
  ...
  "api-errors.user.already_in_organization":
    "Acest utilizator este deja în această organizație.",
  ...
  "api-errors.demo.not_available":
    "Această functie nu este disponibila în demo",
