...
export const translations: Partial<TranslationsDictionary> = {
  ...
  "auth.reset-password.description":
    "Inserisci la nuova password per reimpostare la password.",
  ...
  "auth.register.form.name.max-length":
    "Il nome deve essere inferiore a {{ maxLength }} caratteri",
  ...
  "user.settings.email.description":
    "Il tuo indirizzo email non può essere modificato.",
  ...
  "organization.settings.subscription.error":
    "Impossibile ottenere l'URL del portale clienti",
  ...
  "organization.settings.delete.confirm.message":
    "Sei sicuro di voler eliminare questa organizzazione? Questa azione non può essere annullata e tutti i dati associati saranno rimossi in modo permanente.",
  ...
  "organizations.invite-member.description":
    "Invita un membro nella tua organizzazione",
  ...
  "organizations.invitations.description":
    "Gestisci gli inviti della tua organizzazione",
  ...
  "organizations.invitations.cancel.description":
    "Sei sicuro di voler annullare questo invito?",
  ...
  "documents.rename.form.name.max-length":
    "Il nome deve essere inferiore a 255 caratteri",
  ...
  "documents.preview.unknown-file-type":
    "Nessuna anteprima disponibile per questo tipo di file",
  ...
  "trash.delete-all.confirm.title":
    "Eliminare definitivamente tutti i documenti?",
  ...
  "trash.deleted.success.description":
    "Il documento è stato eliminato definitivamente.",
  ...
  "activity.document.updated.multiple":
    "I campi {{ fields }} sono stati aggiornati",
  ...
  "tags.form.name.max-length":
    "Il nome del tag deve essere inferiore a 64 caratteri",
  ...
  "tags.form.description.placeholder":
    "Es. Tutti i contratti firmati dall'azienda",
  ...
  "tagging-rules.create.error":
    "Errore nella creazione della regola di tagging",
  ...
  "tagging-rules.form.name.max-length":
    "Il nome deve essere inferiore a 64 caratteri",
  "tagging-rules.form.description.label": "Descrizione",
  "tagging-rules.form.description.placeholder":
    "Esempio: Tagga i documenti con 'fattura' nel nome",
  ...
  "tagging-rules.form.conditions.description":
    "Definisci le condizioni che devono essere soddisfatte affinché la regola si applichi. Tutte le condizioni devono essere soddisfatte.",
  ...
  "tagging-rules.form.conditions.no-conditions.confirm":
    "Applica regola senza condizioni",
  ...
  "tagging-rules.form.tags.min-length":
    "È richiesto almeno un tag da applicare",
  ...
  "tagging-rules.update.error":
    "Errore nell'aggiornamento della regola di tagging",
  ...
  "intake-emails.count":
    "{{ count }} email di acquisizione per questa organizzazione",
  ...
  "intake-emails.allowed-origins.add.label":
    "Aggiungi email origine consentita",
  ...
  "api-keys.create.description":
    "Crea una nuova chiave API per accedere all'API di Papra.",
  ...
  "api-keys.list.empty.description":
    "Crea una chiave API per accedere all'API di Papra.",
  ...
  "webhooks.list.empty.description":
    "Crea il tuo primo webhook per iniziare a ricevere eventi",
  ...
  "webhooks.delete.confirm.message":
    "Sei sicuro di voler eliminare questo webhook?",
  ...
  "api-errors.intake-emails.already_exists":
    "Questo indirizzo email di acquisizione esiste già. Riprova.",
  ...
  "api-errors.user.already_in_organization":
    "Questo utente è già in questa organizzazione.",
  ...
  "api-errors.demo.not_available":
    "Questa funzionalità non è disponibile nella demo",
  "api-errors.tags.already_exists":
    "Esiste già un tag con questo nome per questa organizzazione",
