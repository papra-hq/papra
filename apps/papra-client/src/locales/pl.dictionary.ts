...
export const translations: Partial<TranslationsDictionary> = {
  ...
  "auth.reset-password.description":
    "Wprowadź nowe hasło, aby zresetować dotychczasowe.",
  ...
  "auth.register.register-with-provider":
    "Zarejestruj się przez {{ provider }}",
  ...
  "user.settings.email.description":
    "Twój adres e-mail nie może być zmieniony.",
  ...
  "organization.settings.page.description":
    "Zarządzaj ustawieniami swojej organizacji.",
  ...
  "organization.settings.name.updated":
    "Nazwa organizacji została zaktualizowana",
  ...
  "organization.settings.subscription.error":
    "Nie udało się uzyskać adresu URL portalu klienta",
  ...
  "organization.settings.delete.confirm.message":
    "Czy na pewno chcesz usunąć tę organizację? Ta operacja jest nieodwracalna, a wszystkie dane związane z tą organizacją zostaną trwale usunięte.",
  ...
  "organizations.members.delete.success":
    "Członek został usunięty z organizacji",
  "organizations.members.update-role.success":
    "Rola członka została zaktualizowana",
  ...
  "organizations.invite-member.description":
    "Zaproś członka do swojej organizacji",
  ...
  "organizations.invite-member.success.description":
    "E-mail został zaproszony do organizacji.",
  ...
  "organizations.invitations.description":
    "Zarządzaj zaproszeniami do swojej organizacji",
  ...
  "import-documents.title.pending":
    "{{ count }} / {{ total }} dokumentów zaimportowanych",
  ...
  "activity.document.updated.multiple":
    "Pola {{ fields }} zostały zaktualizowane",
  ...
  "tags.form.description.placeholder":
    "Przykład: Wszystkie umowy podpisane przez firmę",
  ...
  "tagging-rules.create.success":
    "Reguła tagowania została pomyślnie utworzona",
  ...
  "tagging-rules.form.description.max-length":
    "Opis musi mieć mniej niż 256 znaków",
  "tagging-rules.form.conditions.label": "Warunki",
  "tagging-rules.form.conditions.description":
    "Zdefiniuj warunki, które muszą być spełnione, aby reguła mogła zostać zastosowana. Wszystkie warunki muszą być spełnione, aby reguła mogła zostać zastosowana.",
  ...
  "tagging-rules.form.conditions.value.min-length":
    "Proszę wprowadzić wartość dla warunku",
  ...
  "tagging-rules.form.tags.min-length":
    "Co najmniej jeden tag do zastosowania jest wymagany",
  ...
  "intake-emails.count":
    "{{ count }} adres/ów e-mail do przyjęć dla tej organizacji",
  ...
  "api-keys.create.description":
    "Utwórz nowy klucz API, aby uzyskać dostęp do API Papra.",
  ...
  "api-keys.list.empty.description":
    "Utwórz klucz API, aby uzyskać dostęp do API Papra.",
  ...
  "webhooks.list.empty.description":
    "Utwórz pierwszy webhook, aby rozpocząć odbieranie zdarzeń",
  ...
  "webhooks.create.form.events.required":
    "Co najmniej jedno zdarzenie jest wymagane",
  ...
  "webhooks.events.documents.document:tag:added.description":
    "Tag został dodany do dokumentu",
  "webhooks.events.documents.document:tag:removed.description":
    "Tag został usunięty z dokumentu",
  ...
  "api-errors.intake-emails.already_exists":
    "Ten adres e-mail do przyjęć już istnieje. Spróbuj ponownie.",
  ...
  "api-errors.user.already_in_organization":
    "Ten użytkownik należy już do tej organizacji.",
  ...
  "api-errors.tags.already_exists":
    "Tag o tej nazwie już istnieje w tej organizacji",
