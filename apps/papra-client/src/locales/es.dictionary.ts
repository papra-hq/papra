...
export const translations: Partial<TranslationsDictionary> = {
  ...
  "auth.register.form.name.max-length":
    "El nombre debe tener menos de {{ maxLength }} caracteres",
  ...
  "user.settings.email.description":
    "Tu dirección de correo electrónico no puede ser cambiada.",
  ...
  "organizations.create.form.name.required":
    "Por favor, ingresa un nombre para la organización",
  ...
  "organization.settings.page.description":
    "Administra la configuración de tu organización aquí.",
  ...
  "organization.settings.subscription.error":
    "Error al obtener la URL del portal del cliente",
  ...
  "organization.settings.delete.confirm.message":
    "¿Estás seguro de que deseas eliminar esta organización? Esta acción no se puede deshacer, y todos los datos asociados se eliminarán permanentemente.",
  ...
  "organizations.invite-member.description":
    "Invita a un miembro a tu organización",
  ...
  "organizations.invitations.description":
    "Administra las invitaciones de tu organización",
  ...
  "import-documents.no-import-in-progress":
    "No hay importación de documentos en curso",
  ...
  "activity.document.updated.single":
    "El campo {{ field }} ha sido actualizado",
  "activity.document.updated.multiple":
    "Los campos {{ fields }} han sido actualizados",
  ...
  "tagging-rules.form.name.min-length":
    "Por favor, ingresa un nombre para la regla",
  ...
  "tagging-rules.form.conditions.description":
    "Define las condiciones que deben cumplirse para que la regla se aplique. Todas las condiciones deben cumplirse.",
  ...
  "tagging-rules.form.conditions.value.min-length":
    "Por favor, ingresa un valor para la condición",
  ...
  "tagging-rules.form.tags.min-length":
    "Se requiere al menos una etiqueta para aplicar",
  ...
  "intake-emails.count":
    "{{ count }} correo{{ plural }} de ingreso para esta organización",
  ...
  "intake-emails.allowed-origins":
    "Permitido desde {{ count }} dirección{{ plural }}",
  ...
  "intake-emails.allowed-origins.add.label":
    "Añadir dirección de correo permitida",
  ...
  "api-keys.create.description":
    "Crea una nueva clave API para acceder a la API de Papra.",
  ...
  "api-keys.list.empty.description":
    "Crea una clave API para acceder a la API de Papra.",
  ...
  "api-errors.document.file_too_big":
    "El archivo del documento es demasiado grande",
  "api-errors.intake-emails.already_exists":
    "Ya existe un correo de ingreso con este nombre",
  ...
  "api-errors.user.already_in_organization":
    "Este usuario ya está en esta organización.",
  ...
  "api-errors.demo.not_available":
    "Esta función no está disponible en la demostración",
  "api-errors.tags.already_exists":
    "Ya existe una etiqueta con este nombre en esta organización",
