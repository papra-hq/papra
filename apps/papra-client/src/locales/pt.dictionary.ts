...
export const translations: Partial<TranslationsDictionary> = {
  ...
  'tagging-rules.apply.confirm.description': 'Esta regra de etiquetagem será aplicada a todos os documentos existentes na organização que correspondem às condições da regra. Esta operação ocorre em segundo plano e pode demorar algum tempo dependendo do número de documentos na organização.',
