...
export const translations: Partial<TranslationsDictionary> = {
  ...
  "auth.register.form.name.max-length":
    "O nome deve ter menos de {{ maxLength }} caracteres",
  ...
  "organizations.create.form.name.required":
    "Por favor, introduza um nome para a organização",
  ...
  "organization.settings.page.description":
    "Gira as definições da sua organização aqui.",
  ...
  "organization.settings.subscription.error":
    "Falha ao obter URL do portal do cliente",
  ...
  "organization.settings.delete.confirm.message":
    "Tem a certeza de que quer eliminar esta organização? Esta ação não pode ser desfeita e todos os dados associados a esta organização serão permanentemente removidos.",
  ...
  "organizations.invite-member.description":
    "Convide um membro para a sua organização",
  ...
  "organizations.invite-member.success.description":
    "O e-mail foi convidado para a organização.",
  ...
  "organizations.invitations.description":
    "Gira os convites da sua organização",
  ...
  "documents.rename.form.name.required":
    "Por favor, introduza um nome para o documento",
  ...
  "trash.delete-all.confirm.title":
    "Eliminar permanentemente todos os documentos?",
  ...
  "trash.deleted.success.description":
    "O documento foi eliminado permanentemente.",
  ...
  "tags.form.name.max-length":
    "O nome da etiqueta deve ter menos de 64 caracteres",
  ...
  "tags.form.description.placeholder":
    "Ex. Todos os contratos assinados pela empresa",
  "tags.form.description.max-length":
    "A descrição deve ter menos de 256 caracteres",
  ...
  "tagging-rules.form.name.min-length":
    "Por favor, introduza um nome para a regra",
  ...
  "tagging-rules.form.conditions.description":
    "Defina as condições que devem ser cumpridas para a regra se aplicar. Todas as condições devem ser cumpridas para a regra se aplicar.",
  ...
  "tagging-rules.form.conditions.value.min-length":
    "Por favor, introduza um valor para a condição",
  ...
  "tagging-rules.form.tags.min-length":
    "É necessária pelo menos uma etiqueta para aplicar",
  ...
  "intake-emails.count":
    "{{ count }} e-mail{{ plural }} de receção para esta organização",
  ...
  "intake-emails.allowed-origins":
    "Permitido de {{ count }} endereço{{ plural }}",
  ...
  "intake-emails.allowed-origins.add.label":
    "Adicionar e-mail de origem permitida",
  ...
  "api-keys.create.description":
    "Crie uma nova chave API para aceder à API do Papra.",
  ...
  "api-keys.list.empty.description":
    "Crie uma chave API para aceder à API do Papra.",
  ...
  "webhooks.list.empty.description":
    "Crie o seu primeiro webhook para começar a receber eventos",
  ...
  "webhooks.delete.confirm.message":
    "Tem a certeza de que deseja eliminar este webhook?",
  ...
  "api-errors.intake-emails.already_exists":
    "Este endereço de e-mail de entrada já existe. Tente novamente.",
  ...
  "api-errors.user.already_in_organization":
    "Este utilizadpr já faz parte desta organização.",
  ...
  "api-errors.demo.not_available":
    "Este recurso não está disponível em ambiente de demonstração",
  "api-errors.tags.already_exists":
    "Já existe uma etiqueta com este nome nesta organização",
