...
export const ORGANIZATION_MEMBER_ID_REGEX = createPrefixedIdRegex({
  prefix: ORGANIZATION_MEMBER_ID_PREFIX,
});

export const ORGANIZATION_INVITATION_ID_PREFIX = 'org_inv';
export const ORGANIZATION_INVITATION_ID_REGEX = createPrefixedIdRegex({
  prefix: ORGANIZATION_INVITATION_ID_PREFIX,
});
