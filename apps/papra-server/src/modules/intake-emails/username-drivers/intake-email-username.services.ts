...
import type {
  ...
  IntakeEmailUsernameDriverFactory,
} from './intake-email-username.models';
...
export function createIntakeEmailUsernameServices({
  ...
  const intakeEmailUsernameDriver: IntakeEmailUsernameDriverFactory | undefined =
    intakeEmailUsernameDrivers[driver as IntakeEmailUsernameDriverName];
