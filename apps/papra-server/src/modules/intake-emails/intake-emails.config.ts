...
import { schemaUsernameIntakeEmailDriverConfig } from "./drivers/schema-username/schema-username.intake-email-driver.config";
...
export const intakeEmailsConfig = {
  ...
  drivers: {
    ...
    schemaUsername: schemaUsernameIntakeEmailDriverConfig,
  },
