...
describe('database-fts5 repository', () => {
  describe('searchOrganizationDocuments', () => {
    ...
    test('search query can have special characters', async () => {
      ...
      const { documents: searchResults1 } =
        await documentsSearchRepository.searchOrganizationDocuments({
          organizationId: 'org_1',
          searchQuery: 'énorme',
          pageIndex: 0,
      ...
      const { documents: searchResults2 } =
        await documentsSearchRepository.searchOrganizationDocuments({
          organizationId: 'org_1',
          searchQuery: "c'est",
          pageIndex: 0,
    ...
    describe('pagination', () => {
      test('pagination permits retrieving subsequent pages of results', async () => {
        ...
        expect(firstPageDocuments.map((doc) => doc.id)).to.eql([
          'doc_25',
          'doc_24',
          'doc_23',
          'doc_22',
        ...
        expect(secondPageDocuments.map((doc) => doc.id)).to.eql([
          'doc_20',
          'doc_19',
          'doc_18',
          'doc_17',
      ...
      const documents = [
        {
          id: 'doc_1',
          organizationId: 'org_1',
          name: 'Invoice cloudflare',
          originalName: 'document-1.pdf',
          content: 'Cloudflare invoice, hosting 5€',
          originalStorageKey: '',
          mimeType: 'application/pdf',
          originalSha256Hash: 'hash1',
          isDeleted: false,
        ...
        },
        {
          id: 'doc_2',
          organizationId: 'org_1',
          name: 'Invoice smartphone',
          originalName: 'document-1.pdf',
          content: 'The smartphone invoice',
          originalStorageKey: '',
          mimeType: 'application/pdf',
          originalSha256Hash: 'hash2',
          isDeleted: false,
        ...
        },
        {
          ...
          name: 'Car invoice',
          originalName: 'document-1.pdf',
          content: 'Your brand new car invoice, insurance attached',
          originalStorageKey: '',
          mimeType: 'application/pdf',
          originalSha256Hash: 'hash3',
          isDeleted: false,
        ...
        },
        {
          ...
          name: 'Car insurance',
          originalName: 'document-2.pdf',
          content: 'Your car insurance contract',
          originalStorageKey: '',
          mimeType: 'application/pdf',
        ...
        },
        {
          ...
          name: 'Meeting notes',
          originalName: 'document-3.pdf',
          content: 'Notes from the meeting about the new project',
          originalStorageKey: '',
          mimeType: 'application/pdf',
    ...
    test('enforces organization isolation to prevent searching documents from other organizations', async () => {
      const documents = [
        ...
        },
        {
          id: 'doc_4',
          organizationId: 'org_2',
          name: 'Another Confidential File',
          originalName: 'confidential.pdf',
          content: 'more confidential information',
          originalStorageKey: '',
          mimeType: 'application/pdf',
          originalSha256Hash: 'hash4',
          isDeleted: false,
      ...
      const { documents: org1SpecificSearch } =
        await documentsSearchRepository.searchOrganizationDocuments({
          organizationId: 'org_1',
  ...
  describe('custom property filters', () => {
    ...
    describe('unknown custom property key', () => {
      test('a filter for an unknown key returns no results without crashing', async () => {
        ...
        await documentsSearchRepository.indexDocuments({
          documents: [
            { id: 'doc_1', organizationId: 'org_1', name: 'File', content: '', isDeleted: false },
          ],
        });
          ...
          documentCustomPropertyValues: [
            {
              id: 'dcpv_1',
              documentId: 'doc_1',
              propertyDefinitionId: 'cpd_org1',
              booleanValue: true,
            },
            {
              id: 'dcpv_2',
              documentId: 'doc_2',
              propertyDefinitionId: 'cpd_org2',
              booleanValue: true,
            },
          ],
        });
