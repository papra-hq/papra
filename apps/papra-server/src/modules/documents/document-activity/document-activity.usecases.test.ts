...
import {
  registerDocumentActivityLog,
  registerDocumentsActivityLog,
} from './document-activity.usecases';
        ...
        documents: [
          {
            ...
            name: 'Doc 1',
            originalName: 'Doc 1',
            originalStorageKey: 'doc-1',
            originalSha256Hash: 'doc-1',
            mimeType: 'text/plain',
          },
        ],
      });
  ...
  describe('registerDocumentsActivityLog', () => {
      ...
      const { db } = await createInMemoryDatabase({
        ...
        documents: [
          ...
          },
          {
            ...
            name: 'Doc 2',
            originalName: 'Doc 2',
            originalStorageKey: 'doc-2',
            originalSha256Hash: 'doc-2',
            mimeType: 'text/plain',
          },
          {
            id: 'doc-3',
            ...
            name: 'Doc 3',
            originalName: 'Doc 3',
            originalStorageKey: 'doc-3',
            originalSha256Hash: 'doc-3',
            mimeType: 'text/plain',
          },
        ],
      });
    ...
    test('preserves per-entry differences in event, userId, and eventData', async () => {
      ...
      const rows = await db
        ...
        .orderBy(documentActivityLogTable.documentId);
