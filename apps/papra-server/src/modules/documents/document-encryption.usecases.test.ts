...
import { createStorageServiceFromDriver } from '../storage/storage.services';
  ...
  describe('encryptAllUnencryptedDocuments', () => {
    test('given a papra instance with some encrypted and some unencrypted documents, it should encrypt all unencrypted documents', async () => {
      ...
      const createDocumentWithoutEncryption = createDocumentCreationUsecase({
        ...
        documentsStorageService: createStorageServiceFromDriver({
          storageDriver,
          encryptionOptions: {
      ...
      const documentStorageServiceWithEncryption = createStorageServiceFromDriver({
        storageDriver,
        encryptionOptions: {
