...
export const documentsTable = sqliteTable(
  ...
  (table) => [
    ...
    index('documents_organization_id_is_deleted_created_at_index').on(
    ...
    uniqueIndex('documents_organization_id_original_sha256_hash_unique').on(
      table.organizationId,
      table.originalSha256Hash,
    ),
