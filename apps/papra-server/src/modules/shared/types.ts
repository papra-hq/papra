...
export type ExtendReturnPromise<Method, NewReturn extends Record<string, unknown>> = Method extends (args: infer Args) => Promise<infer Return> ? (args: Args) => Promise<[Return] extends [void] ? NewReturn : Return & NewReturn> : never;
