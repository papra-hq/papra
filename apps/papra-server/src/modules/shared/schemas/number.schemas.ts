...
export const positiveIntegerSchema = v.pipe(v.number(), v.integer(), v.minValue(0));

export const coercedNumberSchema = v.union([v.number(), v.pipe(v.string(), v.toNumber())]);
...
export const strictlyPositiveIntegerSchema = v.pipe(v.number(), v.integer(), v.minValue(1));
